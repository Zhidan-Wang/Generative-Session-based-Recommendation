...
all_train_path = './data/yoochoose1_64/all_train.pickle'
...
with open('data/yoochoose1_64/train.pickle', 'wb')as file:
    pickle.dump(train_sample, file)
with open('data/yoochoose1_64/valid.pickle', 'wb')as file:
